...
CREATE TABLE `funcionario` (
  ...
  KEY `codDep` (`codDep`),
  CONSTRAINT `funcionario_ibfk_1` FOREIGN KEY (`codDep`) REFERENCES `departamento` (`codigo`)
...
INSERT INTO `funcionario` VALUES ('dfssfd','aaasd','ffff',9999),('fdff','sss','ffff',99888);
